...
import (
	...
	"github.com/bpfs/dep2p/util"
	ipns_pb "github.com/bpfs/dep2p/util/ipns/pb"
	"github.com/bpfs/dep2p/util/path"
...
//
// [IPNS Record]: https://specs.dep2p.tech/ipns/ipns-record/
type Record struct {
...
//
// [Protobuf-serialized]: https://specs.dep2p.tech/ipns/ipns-record/#record-serialization-format
...
//
// [Protobuf serialization format]: https://specs.dep2p.tech/ipns/ipns-record/#record-serialization-format
...
func NewRecord(sk ic.PrivKey, value path.Path, seq uint64, eol time.Time, ttl time.Duration, opts ...Option) (*Record, error) {
	...
	if options.v1Compatibility {
		...
		// but setting it here allows legacy nodes (e.g., go-dep2p < v0.9.0) to
