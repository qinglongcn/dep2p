...
// [IPNS Name]: https://specs.dep2p.tech/ipns/ipns-record/#ipns-name
type Name struct {
...
//
// [string representation]: https://specs.dep2p.tech/ipns/ipns-record/#string-representation
...
//
// [routing purposes]: https://specs.dep2p.tech/ipns/ipns-record/#routing-record
...
func (n Name) Cid() cid.Cid {
	...
	return cid.NewCidV1(cid.DeP2PKey, m)
}
...
// String returns the human-readable IPNS Name, encoded as a CIDv1 with dep2p-key
