...
import (
	...
	"github.com/bpfs/dep2p/p2p/muxer/yamux"
	"github.com/bpfs/dep2p/p2p/net/connmgr"
	"github.com/bpfs/dep2p/p2p/security/noise"
	tls "github.com/bpfs/dep2p/p2p/security/tls"
	quic "github.com/bpfs/dep2p/p2p/transport/quic"
	"github.com/bpfs/dep2p/p2p/transport/tcp"
	ws "github.com/bpfs/dep2p/p2p/transport/websocket"
...
// dep2p instead of replacing them.
...
// Defaults configures dep2p to use the default options. Can be combined with
...
// FallbackDefaults applies default options to the dep2p node if and only if no
