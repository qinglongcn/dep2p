...
// TestPrint 是一个测试函数，用于测试打印路由表的功能
...
// TestBucket 是一个测试函数，用于测试桶（bucket）结构的基本功能
...
// TestNPeersForCpl 是一个测试函数，用于测试 NPeersForCpl 方法的功能
...
// TestUsefulNewPeer 是一个测试函数，用于测试 UsefulNewPeer 方法的功能
...
// TestEmptyBucketCollapse 是一个测试函数，用于测试空桶的折叠功能
...
// TestRemovePeer 是一个测试函数，用于测试移除 Peer 的功能
...
// TestTableCallbacks 是一个测试函数，用于测试 RoutingTable 的回调函数功能
...
// TestTryAddPeerLoad 是一个测试函数，用于测试 TryAddPeer 方法在高负载情况下的性能和稳定性
