...
// DefaultBootstrapPeers is a set of public DHT bootstrap peers provided by dep2p.
...
func init() {
	for _, s := range []string{
		"/dnsaddr/bootstrap.dep2p.io/p2p/QmNnooDu7bfjPFoTZYxMNLWUQJyrVwtbZg5gBMjTezGAJN",
		"/dnsaddr/bootstrap.dep2p.io/p2p/QmQCU2EcMqAqQPR2i9bChDtGNJchTbq5TbXJJ16u19uLTa",
		"/dnsaddr/bootstrap.dep2p.io/p2p/QmbLHAnMoJPWSCR5Zhtx6BHJX9KiKNN6tpvbUcqanj75Nb",
		"/dnsaddr/bootstrap.dep2p.io/p2p/QmcZf59bWwK5XFi76CZX8cbJ4BhTzzA3gU1ZjYZcYW3dwt",
		"/ip4/104.131.131.82/tcp/4001/p2p/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ", // mars.i.dep2p.io
	} {
...
func GetDefaultBootstrapPeerAddrInfos() []peer.AddrInfo {
	...
	for i := range DefaultBootstrapPeers {
		...
		if err != nil {
			logrus.Error("failed to convert bootstrapper address to peer addr info", "address",
...
// Bootstrap tells the DHT to get into a bootstrapped state satisfying the DeP2PRouter interface.
func (dht *DeP2PDHT) Bootstrap(ctx context.Context) (err error) {
