...
// /myapp/kad/1.0.0 instead of /dep2p/kad/1.0.0. Prefix should be of the form /myapp.
//
...
// /dep2p/lan/kad/1.0.0 instead of /dep2p/kad/1.0.0. extension should be of the form /lan.
