...
import (
	...
	helper "github.com/bpfs/dep2p/util/routinghelpers"

	"github.com/hashicorp/go-multierror"
)

const tracer = tracing.Tracer("go-dep2p-kad-dht/dual")
const dualName = "Dual"

// DHT implements the routing interface to provide two concrete DHT implementationts for use
// in DeP2P that are used to support both global network users and disjoint LAN usecases.
type DHT struct {
	WAN *dht.DeP2PDHT
	LAN *dht.DeP2PDHT
}
...
// DeP2PDHT internal constructions, modulo additional options used by the Dual DHT to enforce
