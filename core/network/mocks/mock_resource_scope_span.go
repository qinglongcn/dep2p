...
// Source: github.com/bpfs/dep2p/core/network (interfaces: ResourceScopeSpan)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_resource_scope_span.go github.com/bpfs/dep2p/core/network ResourceScopeSpan
//
