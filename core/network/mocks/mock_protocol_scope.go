...
// Source: github.com/bpfs/dep2p/core/network (interfaces: ProtocolScope)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_protocol_scope.go github.com/bpfs/dep2p/core/network ProtocolScope
//
