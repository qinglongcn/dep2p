...
// Source: github.com/bpfs/dep2p/core/network (interfaces: ConnManagementScope)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_conn_management_scope.go github.com/bpfs/dep2p/core/network ConnManagementScope
//
