...
import (
	...
	"github.com/bpfs/dep2p/core/internal/catch"
	"github.com/bpfs/dep2p/core/peer/pb"
...
// either through a direct exchange (as in the dep2p identify protocol), or through
