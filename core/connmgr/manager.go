...
//
// The ConnManager interface exported from this package allows dep2p to enforce an
...
// heuristics. The ConnManager allows dep2p to enforce an upper bound on the
