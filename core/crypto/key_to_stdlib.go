...
// KeyPairFromStdKey wraps standard library (and secp256k1) private keys in dep2p/core/crypto keys
...
// PrivKeyToStdKey converts dep2p/core/crypto private keys to standard library (and secp256k1) private keys
...
// PubKeyToStdKey converts dep2p/core/crypto private keys to standard library (and secp256k1) public keys
