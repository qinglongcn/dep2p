...
// http-tagged streams from a dep2p connection.
...
// Addr returns the address for this listener, which is its dep2p Peer ID.
func (l *listener) Addr() net.Addr {
	return &addr{l.host.ID()}
}

// Listen provides a standard net.Listener ready to accept "connections".
// Under the hood, these connections are dep2p streams tagged with the
// given protocol.ID.
