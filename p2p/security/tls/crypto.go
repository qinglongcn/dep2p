...
func PubKeyFromCertChain(chain []*x509.Certificate) (ic.PubKey, error) {
	...
	// find the dep2p key extension, skipping all unknown extensions
...
// This extension is included in a certificate to cryptographically tie it to the dep2p private key.
...
// The certificate includes an extension that cryptographically ties it to the provided dep2p
