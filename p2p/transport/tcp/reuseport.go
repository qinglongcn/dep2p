...
import (
	...
	"github.com/bpfs/dep2p/util/reuseport"
	"github.com/sirupsen/logrus"
)

// envReuseport is the env variable name used to turn off reuse port.
// It default to true.
const envReuseport = "DeP2P_TCP_REUSEPORT"
...
func init() {
	...
	if v == "false" || v == "f" || v == "0" {
		...
		logrus.Infof("REUSEPORT disabled (DeP2P_TCP_REUSEPORT=%s)", v)
	}
}
...
//
//	DeP2P_TCP_REUSEPORT=false dep2p daemon
//
