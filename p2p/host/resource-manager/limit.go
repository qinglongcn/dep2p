/*
Package rcmgr is the resource manager for dep2p. This allows you to track
resources being used throughout your dep2p process. As well as making sure
...
the responsibility of the user of this library (either dep2p or a dep2p
...
func NewFixedLimiter(conf ConcreteLimitConfig) Limiter {
	logrus.Debug("initializing new limiter with config", "limits", conf)
