...
// HTTP transport (as opposed to a dep2p stream transport). Useful, for
...
// native HTTP transport (HTTP peer id authentication is not yet implemented: https://github.com/dep2p/specs/pull/564).
