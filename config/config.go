...
import (
	...
	"github.com/bpfs/dep2p/core/sec/insecure"
	...
	blankhost "github.com/bpfs/dep2p/p2p/host/blank"
	"github.com/bpfs/dep2p/p2p/host/eventbus"
	"github.com/bpfs/dep2p/p2p/host/peerstore/pstoremem"
	rcmgr "github.com/bpfs/dep2p/p2p/host/resource-manager"
	routed "github.com/bpfs/dep2p/p2p/host/routed"
...
func (cfg *Config) makeSwarm(eventBus event.Bus, enableMetrics bool) (*swarm.Swarm, error) {
	...
	if pnet.ForcePrivateNetwork && len(cfg.PSK) == 0 {
		logrus.Error("tried to create a dep2p node with no Private" +
		...
		// enforced even *if* you don't use the dep2p constructor.
...
// NewNode constructs a new dep2p Host from the Config.
//
...
func (cfg *Config) NewNode() (host.Host, error) {
	...
	if l, ok := cfg.ResourceManager.(connmgr.GetConnLimiter); ok {
		...
		if err != nil {
			logrus.Warn(fmt.Sprintf("rcmgr limit conflicts with connmgr limit: %v", err))
		}
	}
